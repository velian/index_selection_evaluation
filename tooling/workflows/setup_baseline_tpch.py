...
data = convert_normal_csvs(
    [
        ...
        "/Users/Julius/masterarbeit/J-Index-Selection/benchmark_results/results_cophy_optimizer_tpch_19_queries.csv",
    ],
...
data_cophy = convert_cophy_csvs(
    [
        "/Users/Julius/masterarbeit/J-Index-Selection/benchmark_results/results_cophy_input_tpch_19_queries.csv"
    ],
...
if PLOT_OVERALL_COSTS:
    ...
    plot_overall_costs(nu_data, removes, 46164891, plot_helper)
...
if PLOT_RUNTIMES:
    ...
    nu_data = [x for x in data if x.sequence not in algorithm_ignores]
    plot_runtime(nu_data, plot_helper)
